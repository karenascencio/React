    ...
    <Container>
      <Row>
        <Col>
          ...
          <Input className="input-text bg-lighterGrayishCyan text-darkCyan text-2xl" onChange={ inputHandlerBill} placeholder={bill} />
        </Col>
      </Row>
      <Row>
        <Col>
          ...
          <div>
            <div className="d-flex flex-wrap p-3">
              ...
              <div className="button-item p-2">
                <Input 
                  className="w-100 bg-lighterGrayishCyan text-darkCyan text-xl font-bold" 
      ...
      <Row>
        <Col>
          ...
          <Input className="input-text bg-lighterGrayishCyan text-darkCyan text-2xl" onChange={inputHandlerPeople} placeholder={people} />
        </Col>
      </Row>
      <Row>
        <Col>
          <Container className="bg-darkCyan rounded p-4">
            ...
            <Row>
              <Col>
                <button className="w-full bg-strongCyan p-2 rounded font-bold text-darkCyan" > RESET </button>
              </Col>
            </Row>
          </Container>
        </Col>
